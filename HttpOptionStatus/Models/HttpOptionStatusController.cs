...
namespace HttpOptionStatus.Models
{
    /// <summary>
    /// GameObjectにMonobehaviours（スクリプト）が追加されました。
    /// Monobehaviourがゲームから受け取ることのできるメッセージの一覧は、https://docs.unity3d.com/ScriptReference/MonoBehaviour.html を参照してください。
    /// </summary>
    public class HttpOptionStatusController : MonoBehaviour
    {
        public static HttpOptionStatusController Instance { get; private set; }
